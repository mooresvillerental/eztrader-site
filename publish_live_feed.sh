...
changed=0
for f in live_signal.json live_portfolio.json live_trades.json live_shadow_stats.json \
...
git add live_signal.json live_portfolio.json live_trades.json live_shadow_stats.json \
